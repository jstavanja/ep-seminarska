  ...
  <table class="table is-hoverable is-striped is-fullwidth">
    ...
    <?php foreach($customers as $customer): ?>
      <tr>
        ...
        <td width="30%">
          <form id="customer-activate-form-<?php echo $customer["id"]; ?>" style="display: none;" action="<?php echo BASE_URL . "seller/activateCustomer"?>" method="post">
            <input type="hidden" name="id" value="<?php echo $customer["id"]; ?>">
          </form>
          <form id="customer-deactivate-form-<?php echo $customer["id"]; ?>" style="display: none;" action="<?php echo BASE_URL . "seller/deactivateCustomer"?>" method="post">
            <input type="hidden" name="id" value="<?php echo $customer["id"]; ?>">
          </form>
          ...
          <a href="<?php echo BASE_URL . "seller/editCustomer/" . $customer["id"];?>" class="button is-info is-small"><i class="fa fa-pencil-square"></i>Uredi</a>
        </td>
      </tr>
    <?php endforeach; ?>
    </tbody>
