  ...
  <table class="table is-hoverable is-striped is-fullwidth">
    ...
    <?php foreach($sellers as $seller): ?>
      <tr>
        ...
        <td width="30%">
          <form id="seller-activate-form-<?php echo $seller["id"]; ?>" style="display: none;" action="/administrator/activateSeller" method="post">
            <input type="hidden" name="id" value="<?php echo $seller["id"]; ?>">
          </form>
          <form id="seller-deactivate-form-<?php echo $seller["id"]; ?>" style="display: none;" action="/administrator/deactivateSeller" method="post">
            <input type="hidden" name="id" value="<?php echo $seller["id"]; ?>">
          </form>
          ...
          <a class="button is-info is-small" href="/administrator/editSeller/<?php echo $seller["id"];?>"><i class="fa fa-pencil-square"></i>Uredi</a>
        </td>
      </tr>
    <?php endforeach; ?>
    </tbody>
