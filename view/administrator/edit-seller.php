...
<div class="container">
<form class="modal-card" action="/index.php/administrator/editSeller/<?php echo $customer["id"];?>" method="POST">
  ...
  <div class="field">
    ...
    <div class="field">
      <span>Pravo ime:</span>
      <p class="control has-icons-left">
        <input name="name" class="input" type="text" value="<?php echo $seller["name"];?>" placeholder="Pravo ime">
        <span class="icon is-small is-left">
          <i class="fa fa-user"></i>
        </span>
      </p>
