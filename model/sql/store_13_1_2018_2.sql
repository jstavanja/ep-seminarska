...
--
-- Gostitelj: localhost
-- Čas nastanka: 10. jan 2018 ob 21.39
...
(6, 'le midget le gang le bang', '113 u tacen gremo mi', 62, 'men'),
(8, 'test', '123', 2, 'women');
...
(5, 'a', 'beceda', 'a@a.com', '$2y$10$AY/6L/OhCAqZlJJH6MGJVeWjLDIQlksTRdx19dxj5HYn4YXzrX3uy', 'administrator', 1, 'sineBine', 'a 1', '1337', '123123123'),
(6, 'a', '', 'kren@kr.en', '$2y$10$ZfgsARSfUJPHDQ7V7DFDF.W7hgXp.cLRgatlwTAeNTJ0/B1mzzA9S', 'user', 1, 'krentip', 'a', '1', ''),
(8, 'asdasdasd', '', 'bos@a.nc', 'a', 'seller', 1, 'bosancek1234', 'asmirova 2', '123', ''),
(9, 'Kret En', '', 'kr@et.en', '$2y$10$eVR0KqSWYvqWNvo.6tkP1.1AtLGfDB0ZH3nqtnhF7sYk4WcwBaqn.', 'user', 1, 'krentip', 'Bosna 51', '12345', ''),
(10, 'a', '', 'test2@dummy.com', '$2y$10$0nh0t7xqpbyXprqG2AEgt.Y63SPa14t0Yiog8iCjRdgtyeOpHiRyK', 'user', 0, 'testerko', 'a', '1337', ''),
...
(16, 'asmir', 'nepovem', 'as@asmir.com', '$2y$10$DOwzKSbmbD5DPFsx0CvTe.TncsnWyMPWgllZv..PwQ/GxPzDiscea', 'user', 1, 'asmir', 'Ne obstaja 1', '8000', '584756691');
